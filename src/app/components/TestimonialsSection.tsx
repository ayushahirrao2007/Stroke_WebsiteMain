            ...
            <div className="relative z-10 animate-fade-in">
              <div className="flex flex-col md:flex-row items-center gap-6 mb-6">
                ...
                <div className="relative group/avatar">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden ring-4 ring-purple-200 group-hover/avatar:ring-purple-400 transition-all transform group-hover/avatar:scale-110">
                    <img
