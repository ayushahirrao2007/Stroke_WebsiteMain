  ...
  return (
    <section id={id} className="bg-gradient-to-br from-purple-700 via-purple-800 to-blue-800 py-12 sm:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-5 sm:p-6 md:p-8 shadow-xl flex flex-col md:flex-row items-center gap-6 md:gap-8">
