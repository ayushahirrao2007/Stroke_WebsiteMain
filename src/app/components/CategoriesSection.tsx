          ...
          {categories.map((category, index) => (
            ...
            >
              ...
              <div className="relative p-8 h-48 flex flex-col justify-between">
                {/* Icon */}
                <div className={`${category.bgColor} rounded-2xl w-16 h-16 flex items-center justify-center transform transition-all duration-500 ${
                  hoveredIndex === index ? 'scale-110 rotate-12' : 'scale-100 rotate-0'
                }`}>
                  <category.icon className="text-purple-700" size={32} />
                </div>
