...
export default function BrainStrokePage() {
    ...
    useEffect(() => {
        fetch('/src/data/Stroke Info/Stroke-info.md')
            .then(res => {
            ...
            .then(text => {
                ...
                setSections(parsed);
                setActiveSection(parsed[0] ?? null);
                setLoading(false);
            })
            .catch(err => {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4 text-white">
                    ...
                    <p className="text-base font-medium opacity-70">Loading guide…</p>
                </div>
            </div>
        );
    }
    ...
    if (error) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 flex items-center justify-center px-4">
                <div className="bg-white/10 border border-red-400/40 rounded-2xl p-8 max-w-md text-center text-white space-y-4">
                    <AlertCircle size={40} className="mx-auto text-red-400" />
                    <h2 className="text-xl font-bold">Could not load content</h2>
