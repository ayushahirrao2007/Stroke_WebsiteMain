...
The brain is a highly specialized and complex organ that serves as the control centre of the human body. It is responsible for regulating nearly all functions necessary for survival and daily life. These include sensory perception, emotions, thinking, memory, movement, and behaviour.

In addition to conscious activities, the brain also manages vital involuntary processes such as breathing, heart rate, and body temperature. Every thought, action, and personality trait that defines an individual originates from the brain.

The brain is composed of billions of nerve cells known as neurons. These neurons communicate with each other through electrical and chemical signals, forming an intricate network that processes and transmits information throughout the body. This communication system allows the body to respond appropriately to internal and external stimuli.

Structurally, the brain consists of multiple regions, each performing specific functions. Despite their specialized roles, these regions work in close coordination to ensure smooth and efficient functioning of the body.

The brain is connected to the spinal cord, and together they form the central nervous system (CNS). This system acts as the main communication pathway, linking the brain to the rest of the body and enabling control over both voluntary and involuntary activities.

### 2. Functions of the Brain

The brain is the central control system of the body, responsible for managing both voluntary actions and involuntary processes. Its functions are wide-ranging and essential for survival, adaptation, and interaction with the environment.

**Key Functions**
- **Regulation of Automatic Activities**
  The brain controls vital unconscious functions such as breathing, heart rate, sleep cycles, and body temperature. 
- **Stress Response (Fight-or-Flight)**
  It enables the body to respond quickly to danger or stress by activating protective mechanisms. 
- **Maintenance of Internal Balance**
  The brain ensures that organs function properly and maintains internal stability (homeostasis). 
- **Memory and Emotions**
  It stores past experiences and processes emotions, shaping behaviour and personality. 
- **Movement and Coordination**
  The brain controls voluntary movements, balance, posture, and coordination of muscles. 
- **Sensory Processing**
  It receives and interprets information from the five senses: vision, hearing, smell, taste, and touch. 
- **Speech and Language**
  The brain enables communication by controlling language comprehension and expression. 
- **Thinking and Decision-Making**
  It is responsible for reasoning, problem-solving, judgment, and decision-making.

### 3. How the Brain Works?

The brain constantly sends, receives, and processes signals through the central nervous system (CNS). These signals carry information from:
- External environment (via senses like sight, sound, smell, taste, and touch) 
- Internal body conditions (such as pain, temperature, and heart rate) 

The brain interprets these signals, giving them meaning so that the body can respond appropriately to different situations.
`
  },
  {
    id: 2,
              ...
              <Card className="bg-white/8 backdrop-blur-sm border border-white/12">
                <CardContent className="pt-6 pb-6">
                  <div className="prose prose-invert max-w-none
                    ...
                    {(() => {
                      console.log(activeTopic.content);
                      const cleanContent = activeTopic.content
                        .replace(/&lt;/g, "<")
                        .replace(/&gt;/g, ">");
