...
Usage:
  python converter.py
  python converter.py "input/CASE 0012.docx"
  python converter.py --validate --strict --overwrite
"""
...
class DocxToMarkdownConverter:
    ...
    def _classify_heading(self, p: Paragraph, is_first_p: bool, prev_was_title: bool) -> Optional[Tuple[int, str]]:
        ...
        # Numbered major section header e.g. "1. AMBULANCE HANDOVER", "24. CT ANGIOGRAPHY (HEAD & NECK)"
